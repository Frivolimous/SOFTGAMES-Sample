...
export class JMTween {
  ...
  private onUpdateCallback: (object: any) => void;
  private onCompleteCallback: (object: any) => void;
  private onWaitCompleteCallback: (object: any) => void;
  ...
  constructor(private object: any | any, private totalTime: number = 200) {
    this.tickThis = this.firstTick;
  }

  public onUpdate = (callback: (object: any) => void) => {
    this.onUpdateCallback = callback;

    return this;
  }

  public onComplete = (callback: (object: any) => void) => {
    this.onCompleteCallback = callback;

    return this;
  }

  public onWaitComplete = (callback: (object: any) => void) => {
  ...
  public to = (props: any, eased = true) => {
  ...
  public from = (props: any, eased = true) => {
    for (let key of Object.keys(props)) {
  ...
  public colorTo = (props: any, eased = true) => {
    for (let key of Object.keys(props)) {
